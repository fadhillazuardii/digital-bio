          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="flex-1">
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed mb-4">
                ...
                <span className="text-cyan-600 dark:text-cyan-400 font-semibold">telecommunications engineering</span>{' '}
                who is passionate about building meaningful digital experiences.
                With expertise in front-end development and quality assurance,
                I combine technical precision with design creativity to create
                products that are not only functional but also aesthetically pleasing.
              </p>
              <p className="text-slate-500 dark:text-slate-400 leading-relaxed">
                I believe that the best technology{' '}
                <span className="text-slate-900 dark:text-white font-medium">solves real problems</span>{' '}
                in elegant and intuitive ways. When I'm not coding, I actively
                explore the latest trends in web development and contribute
            ...
            <div className="flex flex-row md:flex-col gap-3 flex-shrink-0">
              {highlights.map((item) => (
                ...
                >
                  ...
                  <span className="text-slate-700 dark:text-slate-300 font-medium whitespace-nowrap">{item.label}</span>
                </div>
              ))}
            </div>
          </div>
